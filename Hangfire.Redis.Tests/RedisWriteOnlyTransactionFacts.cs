    ...
    public class RedisWriteOnlyTransactionFacts : IClassFixture<RedisFixture>
    {
        ...
        public void Ctor_ThrowsAnException_WhenTransactionIsNull()
        {
            Assert.Throws<ArgumentNullException>(
                () => new RedisWriteOnlyTransaction(null, null));
        }
        ...
        public void SetJobState_ModifiesJobEntry()
        {
            UseConnection(redis =>
            {
                ...
                // Assert
                var hash = redis.HashGetAll("hangfire:job:my-job");
        ...
        public void SetJobState_RewritesStateEntry()
        {
            UseConnection(redis =>
            {
                ...
                // Assert
                var stateHash = redis.HashGetAll("hangfire:job:my-job:state").ToDictionary(x => x.Name, x => x.Value);
        ...
        public void AddToQueue_AddsSpecifiedJobToTheQueue()
        {
            UseConnection(redis =>
            {
                ...
                Assert.Equal("my-job", redis.ListGetByIndex("hangfire:queue:critical", 0));
            });
        }
        ...
        public void AddToQueue_PrependsListWithJob()
        {
            UseConnection(redis =>
            {
                redis.ListRightPush("hangfire:queue:critical", "another-job");
        ...
        public void IncrementCounter_IncrementValueEntry()
        {
            UseConnection(redis =>
            {
                ...
                Assert.Equal("4", redis.StringGet("hangfire:entry"));
        ...
        public void IncrementCounter_WithExpiry_IncrementsValueAndSetsExpirationDate()
        {
            UseConnection(redis =>
            {
                ...
                var entryTtl = redis.KeyTimeToLive("hangfire:entry");
                Assert.Equal("4", redis.StringGet("hangfire:entry"));
        ...
        public void DecrementCounter_DecrementsTheValueEntry()
        {
            UseConnection(redis =>
            {
                ...
                Assert.Equal("2", redis.StringGet("hangfire:entry"));
        ...
        public void AddToSet_AddsItemToSortedSet()
        {
            UseConnection(redis =>
            {
                ...
                Assert.NotNull(redis.SortedSetScore("hangfire:my-set", "my-value"));
            });
        }
        ...
        public void AddToSet_WithScore_AddsItemToSortedSetWithScore()
        {
            UseConnection(redis =>
            {
                ...
                Assert.NotNull(redis.SortedSetScore("hangfire:my-set", "my-value"));
                Assert.Equal(3.2, redis.SortedSetScore("hangfire:my-set", "my-value"));
            });
        }
        ...
        public void RemoveFromSet_RemoveSpecifiedItemFromSortedSet()
        {
            UseConnection(redis =>
            {
                ...
                Assert.Null(redis.SortedSetScore("hangfire:my-set", "my-value"));
            });
        }
        ...
        public void InsertToList_PrependsListWithSpecifiedValue()
        {
            UseConnection(redis =>
            {
                ...
                Assert.Equal("new-value", redis.ListGetByIndex("hangfire:list", 0));
            });
        }
        ...
        public void RemoveFromList_RemovesAllGivenValuesFromList()
        {
            UseConnection(redis =>
            {
                ...
                Assert.Equal("another-value", redis.ListGetByIndex("hangfire:list", 0));
            });
        }
        ...
        public void TrimList_TrimsListToASpecifiedRange()
        {
            UseConnection(redis =>
            {
                ...
                Assert.Equal("2", redis.ListGetByIndex("hangfire:list", 0));
                Assert.Equal("3", redis.ListGetByIndex("hangfire:list", 1));
            });
        }
        ...
        {
            using (var transaction = new RedisWriteOnlyTransaction(connection.CreateTransaction(), Redis.Storage.GetSubscribe()))
            {
                action(transaction);
                transaction.Commit();
            }
